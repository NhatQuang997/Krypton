# Generated by Django 4.0.6 on 2022-09-01 12:35
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.PositiveIntegerField(choices=[(0, 'spot'), (1, 'futures'), (2, 'margin')], default=0)),
                ('side', models.PositiveIntegerField(choices=[(0, 'buy'), (1, 'sell')], default=0)),
                ('copy_user_id', models.IntegerField(blank=True, null=True)),
                ...
                ('donante', models.FloatField(blank=True, null=True)),
                ('copy_fee', models.FloatField(blank=True, null=True)),
